...
namespace SnipInsight.ImageCapture
{
    ...
    public partial class ImageCaptureWindow
    {
        ...
        private const int MagnifierRadius = 41;
...
//#endif
            ...
            if (isRight && isLower)
            {
                return MagnifierPosition.UpperLeft;
            }
            ...
            {
                return MagnifierPosition.LowerRight;
            }
            else if (isRight && isUpper)
            {
                return MagnifierPosition.LowerLeft;
            }
            else if (isLower)
            {
                if (_areaSelection.DraggingRight)
                {
                    return MagnifierPosition.UpperRight;
                }
                else
            ...
            {
                if (_areaSelection.DraggingDown)
                {
                    return MagnifierPosition.LowerRight;
                }
                else
            ...
            else if (!_areaSelection.DraggingDown && _areaSelection.DraggingRight)
            {
                return MagnifierPosition.LowerRight;
            }
